...
export function DraggableFab({
  ...
  return (
    <button
      ...
      className={[
        "mobile-fab-in primary-action fixed z-40 grid size-14 touch-none select-none place-items-center rounded-full bg-accentLight text-onAccentLight dark:bg-accentDark dark:text-onAccentDark transition hover:scale-[1.03] active:scale-[0.92] sm:hidden",
        isDragging
          ? "transition-none"
