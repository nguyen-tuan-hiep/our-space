...
export function ConfirmDialog({
	...
	return (
		...
		>
			<AlertDialogContent className="mx-4 max-w-[calc(100vw-2rem)] overflow-hidden rounded-3xl border border-border bg-surface-elevated p-0 text-foreground shadow-[0_24px_70px_rgba(30,25,20,0.24)] sm:max-w-md">
				<div className="grid gap-4 px-5 pb-2 pt-5 sm:px-6 sm:pt-6">
					<AlertDialogHeader className="place-items-start gap-2 text-left">
						<div className="flex items-center gap-3">
							...
							<AlertDialogTitle className="font-serif text-3xl leading-tight text-foreground">
								{title}
							</AlertDialogTitle>
						</div>
				...
				<AlertDialogFooter className="m-0 mt-3 flex flex-col-reverse gap-2 rounded-none border-t border-border bg-background/70 p-4 sm:flex-row sm:justify-end sm:p-5">
					<AlertDialogCancel
						disabled={pending}
						onClick={onClose}
