	...
	return createPortal(
		<>
			...
			<div
				...
				aria-label={title}
				className={[
					"emoji-picker-dialog fixed inset-x-3 bottom-[calc(env(safe-area-inset-bottom)+0.75rem)] z-[100] overflow-hidden rounded-3xl border border-neutral-900/10 bg-paper shadow-[0_24px_70px_rgba(30,25,20,0.28)] sm:inset-auto sm:left-1/2 sm:top-1/2 sm:w-[min(26rem,calc(100vw-2rem))] sm:-translate-x-1/2 sm:-translate-y-1/2",
