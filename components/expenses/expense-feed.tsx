...
export function ExpenseFeed({
  ...
  return (
    <div className="rounded-[1.5rem] border border-neutral-200 bg-paper p-4 shadow-md rounded-2xl sm:p-5">
      ...
      <div className="grid max-h-[28rem] gap-3 overflow-y-auto pr-1 sm:gap-5">
        {filteredExpenses.length ? (
                    ...
                    {canEdit && (
                      ...
                      >
                        <button
                          ...
                          disabled={isDeleting}
                          className="grid size-9 place-items-center rounded-full text-neutral-500 transition active:scale-95 hover:bg-mui/10 disabled:cursor-not-allowed disabled:opacity-50 sm:size-8"
                        >
          ...
          <p className="rounded-[1.25rem] border border-dashed border-neutral-300 py-10 text-center text-neutral-500 sm:rounded-lg sm:border-neutral-400">
            {expenses.length
