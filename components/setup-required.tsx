		...
		<main className="min-h-svh bg-bg">
			<section className="container-page grid min-h-svh items-center py-12">
				<Card className="mx-auto w-full max-w-3xl border border-neutral-200 bg-paper p-6 sm:p-8">
					...
					<div className="mt-6 grid gap-3 bg-paper p-4 text-sm">
						<p>
						...
						<p>
							...
							{profile
								? "found, but partner_id is missing or unreadable"
								: "missing"}
						</p>
						{profile?.partner_id ? (
							<p>
					...
					<pre className="mt-6 overflow-auto p-4 text-xs leading-6 text-white">
